...
unlike( $out, qr/.....UG..  d $pb/, 'pug control before missing' )
  or diag("out=$out\n");
my $tst = -f $spec;
...
like( $out, qr/.....UG..  d $pb/, 'pug control after missing' )
  or diag("out=$out\n");
$tst = -f $spec;
...
like( $out, qr/.....UG..  d $pb/, 'pug pug-from-db missing' )
  or diag("out=$out\n");
$tst = -f $spec;
...
like( $out, qr/.....UG..  d $pb/, 'pug pug-from-fs missing' )
  or diag("out=$out\n");
$tst = -f $spec;
...
like( $out, qr/.....UG..  d $pb/, 'pug keep-perm missing' )
  or diag("out=$out\n");
$tst = -f $spec;
...
like( $out, qr/.....UG..  d $pb/, 'pug short keep-perm missing' )
  or diag("out=$out\n");
$tst = -f $spec;
